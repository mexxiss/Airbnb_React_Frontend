...
import { East, StarRounded } from "@mui/icons-material";
                ...
                <Modal.Body className="p-0 rounded-lg">
                    <div className="quickView h-[450px]">
                        <div className="grid grid-cols-2 h-full">
                            ...
                            <div>
                                <div className="p-4 h-[calc(100%-1rem)]">
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <p className="mt-1 text-[#4D5461] line-clamp-3">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                    </div>
                                    <div className="mt-5">
                                        <button className="btn1 !text-sm tracking-wider !font-normal flex items-center gap-2">View Full Details <span><East className="!text-xl" /></span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
