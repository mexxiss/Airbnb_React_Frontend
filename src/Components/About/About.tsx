      ...
      <div className="relative bg-[#4D360E] py-20">
        <div className="container mx-auto">
          <div className="lg:flex justify-between gap-4 text-center lg:text-left ">
            <h2 className="text-3xl sm:text-[34px] xl:text-[36px] 2xl:text-[42px] font-semibold text-white lg:max-w-[360px] leading-[50px] 2xl:leading-[58px] mx-auto lg:mx-0" data-aos="fade-right" data-aos-duration="600" >
              What <span className="text-primary">people</span> say about{" "}
              <span className="text-primary">us</span>
            </h2>
            <p className="text-[#B7B5CC] font-medium lg:max-w-[600px] xl:max-w-[750px] lg:text-justify mx-auto lg:mx-0 mt-3 lg:mt-0" data-aos="fade-left" data-aos-duration="600" >
          ...
          <div className="grid lg:grid-cols-2 gap-8 my-8 sm:my-12">
            {homeContent?.what_people_says?.facts.map((fact, index) => (
              <div
                key={index}
                className="bg-white bg-opacity-20 rounded-3xl p-6 md:p-8" data-aos="fade-up" data-aos-duration="600" 
              >
          ...
          <div className="mt-8 sm:mt-12">
            <div className="flex items-center justify-center gap-4 sm:gap-10 lg:gap-14 text-center">
              <div>
                <h4 className=" font-bold text-3xl sm:text-4xl md:text-[42px] text-white" data-aos="fade-up" data-aos-duration="600" >
                  {homeContent?.property_return_rate}%
                </h4>
                <p className=" text-[#C6C4D6] font-medium mt-1 text-sm sm:text-base" data-aos="fade-up" data-aos-duration="600" >
