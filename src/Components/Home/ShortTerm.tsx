    ...
    <div className="py-16 md:py-20 lg:py-24">
      <div className="container mx-auto">
        <div className="pl-12 xs:pl-20 relative z-20">
          <div data-aos="fade-right" data-aos-duration="1200" data-aos-delay="100" className="max-w-max sm:max-w-[200px] bg-white w-full rounded-b-xl sm:rounded-b-[20px] shadow-[40.05px_40.05px_74.38px_0px_#7065F026] border-2 border-[#ecebf5] px-4 pt-4 sm:pt-10 pb-4 sm:pb-7 flex items-center justify-center relative">
        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-14 -mt-16 sm:-mt-40">
          ...
          <div className="lg:pb-10">
            <h4 className=" text-3xl sm:text-[34px] xl:text-[36px] 2xl:text-[42px] sm:leading-[50px] font-semibold text-text1" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="50">
              Short-Term Rentals in Dubai: Key Insights
            </h4>
            <p className="sm:text-lg text-[#505864] mt-5" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="150">
