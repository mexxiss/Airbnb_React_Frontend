  ...
  return (
    <div className="py-16 md:py-20 lg:py-24">
      <div className="container mx-auto">
        <div>
          <h4 className="text-3xl sm:text-[34px] xl:text-[36px] 2xl:[42px] font-semibold text-center text-text1" data-aos="fade-up" data-aos-duration="600" data-aos-delay="400">
        ...
        <div className="mt-10 md:mt-12 space-y-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-12 items-center justify-center max-w-[1200px] mx-auto opacity-50">
            ...
            <div data-aos="zoom-in-up" data-aos-duration="600" data-aos-delay="400">
              <span>
                <img
            ...
            <div data-aos="zoom-in-up" data-aos-duration="600" data-aos-delay="450">
              <span>
                <img
