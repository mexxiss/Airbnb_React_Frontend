...
import { bg1, cleaningFaq, img1 } from "../../assets/images/index.ts";
  ...
  return (
    <>
      ...
      <div className="pt-14 md:pt-16 lg:pt-20">
        <div className="container mx-auto">
          <h4 className=" text-[26px] xs:text-3xl sm:text-[34px] xl:text-[36px] 2xl:[42px] font-semibold text-[#1F1607] sm:leading-[48px]" data-aos="fade-right" data-aos-duration="1000" >
            Airbnb Cleaning <br />
            Service & Maintenance
          </h4>
          <p className="text-[#60410C]  mt-3" data-aos="fade-right" data-aos-duration="1000" >
      ...
      <div className="pt-16 md:pt-20 lg:pt-24">
        <div className="container mx-auto">
          <div className="pl-12 xs:pl-20 relative z-20">
            <div className="max-w-max sm:max-w-[200px] bg-white w-full rounded-b-xl sm:rounded-b-[20px] shadow-[40.05px_40.05px_74.38px_0px_#7065F026] border-2 border-[#ecebf5] px-4 pt-4 sm:pt-10 pb-4 sm:pb-7 flex items-center justify-center relative" data-aos="fade-right" data-aos-duration="1000" >
                ...
                {homeContent?.cleaning_maintenance?.what_inclued.map(
                  (item, index) => (
                    <li key={index}>
                      ...
                      <p className="text-[#4D5461] mt-2" data-aos="fade-left" data-aos-duration="1000" >{item.description}</p>
                    </li>
                  )
                )}
              </ul>
      ...
      <Suspense fallback={<div>Loading...</div>}>
        <FAQ title="Cleaning & Maintenance FAQs" img_url={cleaningFaq} />
      </Suspense>
    </>
  );
};
