  ...
  return (
    <>
      ...
      <div className="pt-14 md:pt-16 lg:pt-20">
        <div className="container mx-auto">
          <h3 className="text-3xl sm:text-[34px] xl:text-[36px] 2xl:text-[42px] font-semibold text-[#1F1607] font-light] leading-[50px] 2xl:leading-[58px] text-center" data-aos="fade-up" data-aos-duration="1000" >
            Get in touch
          </h3>
          <p className="max-w-[900px] mx-auto text-[#60410C] lg:text-lg  mt-2 text-center" data-aos="fade-up" data-aos-duration="1000" >
          ...
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <div className="py-4 sm:py-7 px-6 bg-white rounded-xl shadow-[0px_0px_20px_0px_#0000001A]" data-aos="zoom-in" data-aos-duration="400" >
            ...
            <div className="py-4 sm:py-7 px-6 bg-white rounded-xl shadow-[0px_0px_20px_0px_#0000001A]" data-aos="zoom-in" data-aos-duration="800" >
              <div className="flex flex-col h-full">
                <div className="w-20 h-20 rounded-full flex items-center justify-center bg-[#fff6e7]">
            ...
            <div className="py-4 sm:py-7 px-6 bg-white rounded-xl shadow-[0px_0px_20px_0px_#0000001A]" data-aos="zoom-in" data-aos-duration="1200" >
              <div className="flex flex-col h-full">
                <div className="w-20 h-20 rounded-full flex items-center justify-center bg-[#fff6e7]">
