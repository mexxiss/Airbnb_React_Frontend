                    ...
                    <div className="grid lg:grid-cols-2 2xl:grid-cols-3 gap-5">
                        <div className="border border-primary px-4 pt-4 pb-6">
                            ...
                            <div className="radio flex flex-col gap-2 mt-3">
                                <div className="flex items-center gap-2">
                                    <Radio id="yes" name="countries" value="Yes" className="focus:ring-offset-0 focus:shadow-none !focus:ring-0"
                                        onClick={handleInternetConfirmation}
                                    />
                                    <Label htmlFor="yes">Yes</Label>
                                </div>
                                <div className="flex items-center gap-2">
                                    <Radio id="no" name="countries" value="No" className="focus:ring-offset-0 focus:shadow-none !focus:ring-0" />
                        ...
                        <div className="border border-primary px-4 pt-4 pb-6">
                            ...
                            <div className="radio flex flex-col gap-2 mt-3">
                                ...
                                <div className="flex items-center gap-2">
                                    <Radio id="no" name="countries" value="No" className="focus:ring-offset-0 focus:shadow-none !focus:ring-0" defaultChecked />
                                    <Label htmlFor="no">No - please organize this for me</Label>
                                </div>
                            </div>
                            {/* If No */}
                                ...
                                <FormikProvider value={formik}>
                                    <Form onSubmit={formik.handleSubmit}>
                                        <div className="grid grid-cols-1 gap-4">
                                            <div>
                                                <Input inputClass="!py-2" name="email" type="email" label="Email" value="" />
                                                <p className="text-xs mt-2 text-gray-500">Please upload your documents in the document section so we can proceed with the application</p>
                                            </div>
                                            <Select options={paidOptions} name="paidBy" label="Paid By" value="" />
                                        </div>
                                    </Form>
                                </FormikProvider>
                            </div>
                        ...
                        <div className="border border-primary px-4 pt-4 pb-6">
                            ...
                            <div>
                                <FormikProvider value={formik}>
                                    <Form onSubmit={formik.handleSubmit}>
                                        <div className="grid grid-cols-1 gap-4">
                                            <Select options={options} name="selectProvider" label="Select Provider" value="" />
                                            <Input inputClass="!py-2" name="accNo" type="text" label="Account Number" value="" />
                                            <Select options={paidOptions} name="paidBy" label="Paid By" value="" />
                                            <Input inputClass="!py-2" name="webLogin" type="text" label="Web Login" value="" />
                                            <Input inputClass="!py-2" name="webPassword" type="text" label="Web Password" value="" />
                                        </div>
                                    </Form>
                                </FormikProvider>
                            </div>
                        ...
                        <div className="border border-primary px-4 pt-4 pb-6 flex items-center justify-center">
                            <button className="btn1 w-full !rounded-none">Add New Utility</button>
                        </div>
                    </div>
                </div>
                <div className="mt-8">
